...
export function setupTouch(){
  ...
  function clearDir(){ keys.left=keys.right=keys.up=keys.down=false; }
  ...
  function buildGuide(isReady){
    ...
    g.innerHTML=[
      ...
      '<b>しゃがみ</b>：スティックを下',
      '<b>ジャンプ</b>：スティックを上',
      '<b>2段ジャンプ</b>：空中でもう一度「上」',
      '<b>ジャンプアッパー</b>：「上」＋「弱」を同時<br><span class="tp-note">高く飛んで攻撃。飛ぶ敵や回復アイテムに強い</span>',
      '<b>攻撃</b>：弱 ／ 強',
